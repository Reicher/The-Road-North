...
func _test_destroy_tile_event() -> void:
	...
	_assert(not placement.get_node("PlacementControls/Buttons/RotateLeftButton").visible, "Expected targeting controls to hide left rotate")
	_assert(not placement.get_node("PlacementControls/Buttons/RotateRightButton").visible, "Expected targeting controls to hide right rotate")
